...
class UserAdmin(admin.ModelAdmin):
    ...
    def activate_users(self, request, queryset):
        ...
        self.message_user(
            request, f"Đã kích hoạt và gửi thông báo cho {queryset.count()} tài khoản.", messages.SUCCESS
        )
    ...
    def manually_verify_identity(self, request, queryset):
        with transaction.atomic():
            for user in queryset:
                task_with_args = partial(
                    ...
                    title="Chúc mừng, bạn đã xác minh danh tính thành công!",
        ...
        self.message_user(
            request, f"Đã xác minh danh tính và gửi thông báo cho {updated_count} tài khoản.", messages.SUCCESS
        )
