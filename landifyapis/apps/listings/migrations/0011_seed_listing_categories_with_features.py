...
def populate_listing_categories(apps, schema_editor):
    ...
    rent_townhouse_features = [
        features.get("NUM_BEDROOMS"),
        features.get("NUM_BATHROOMS"),
        features.get("DEPOSIT_AMOUNT"),
        features.get("MIN_LEASE_DURATION"),
        features.get("ALLOW_PETS"),
    ]
