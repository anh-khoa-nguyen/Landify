...
#
#     commission_percentage = models.FloatField("Phần trăm hoa hồng (%)", default=0.0)
#
#     def __str__(self):
#         return self.title
#
...
#         related_name='brokered_contracts',
#         verbose_name="Môi giới chốt deal")
#
# class ListingBroker(BaseModel):
#     class Status(models.TextChoices):
#         PENDING = 'PENDING', 'Chờ duyệt'
#         ACTIVE = 'ACTIVE', 'Đã duyệt (Đang tham gia)'
#         REJECTED = 'REJECTED', 'Đã từ chối'
#         INACTIVE = 'INACTIVE', 'Đã kết thúc (Deal đã chốt)'
#         CANCELLED = 'CANCELLED', 'Đã hủy hợp tác'
#
#     listing = models.ForeignKey(Listing, on_delete=models.CASCADE, related_name='participating_brokers')
#     broker = models.ForeignKey(User, on_delete=models.CASCADE, related_name='brokerage_listings')
#
#     status = models.CharField(max_length=20, choices=Status.choices, default=Status.PENDING)
#
#     class Meta:
#         unique_together = ('listing', 'broker')
#         verbose_name = "Đơn xin tham gia môi giới"
#         verbose_name_plural = "Các Đơn xin tham gia môi giới"
#
...
#
#     contract = models.OneToOneField(Contract, on_delete=models.CASCADE, related_name='commission_payout')
#     broker = models.ForeignKey(User, on_delete=models.CASCADE, related_name='commission_payouts_received')
#     amount = models.DecimalField("Số tiền hoa hồng", max_digits=19, decimal_places=2)
#     status = models.CharField("Trạng thái thanh toán", max_length=20, choices=Status.choices,
